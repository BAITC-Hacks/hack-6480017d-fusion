...
Подтверждено: **2248 узлов, 3119 рёбер, 4840 транзакций, 81 seed; 2026-07-01 — 2026-07-31**. Все 34 проверки аудита, 10 тестов и сборка проходят. Полные результаты, противоречия и ограничения — [DATA_AUDIT.md](docs/DATA_AUDIT.md); статус и непроверенные сценарии — [PROGRESS.md](docs/PROGRESS.md).
...
Адрес — http://127.0.0.1:4173, proxy настроен аналогично dev. Отдельная браузерная проверка preview пока не проводилась.
