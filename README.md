...
**Аудит готовности:** [проверки, правила ролей, разбор Top-20 и следующий шаг](docs/TECHNICAL_AUDIT.md). Повторные расчёты и новая копия проекта с отдельной venv дают одинаковые CSV. Основные оставшиеся улучшения UI — суммы отдельных связей и видимые слагаемые приоритета; сейчас эти данные доступны через API/выгрузки.
