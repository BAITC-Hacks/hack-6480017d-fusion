...
**2. Исходные данные уже находятся в репозитории:**
...
Три оригинальных Parquet организаторов входят в репозиторий и после клонирования уже находятся в `data/`. Копировать или заменять их не нужно. Не изменять исходные файлы и не удалять повторяющиеся транзакции. Для другого набора используйте кнопку «Данные», описанную ниже. Схема данных — [docs/dataset.md](docs/dataset.md).
