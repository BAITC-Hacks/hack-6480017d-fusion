...
> Исторический аудит версии `a81385a`. Следующий этап закрыл P0 интерфейса: потоки, объяснение приоритета и статус наблюдаемости; добавлена сводка кластера. Текущий статус — **READY — FREEZE CORE**, проверки и ограничения в [PROGRESS.md](PROGRESS.md). Ниже сохранены исходные находки аудита, а не список оставшихся задач. Betweenness по уточнению пользователя отложена в P2.
